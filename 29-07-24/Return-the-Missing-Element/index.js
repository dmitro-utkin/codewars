...
// Our sequence given was supposed to contain 
// all of the integers from 0 to 9 (in no particular order), 
...
// algo
// 0. create new array from 0 to 9 
// 1. sort the array
...
function getMissingElement(sequence){
  ...
  const sumOfFullArray = fullArray.reduce((acc, curr) => acc + curr, 0);
  const sumOfSequence = sequence.reduce((acc, curr) => acc + curr, 0);
  return sumOfFullArray - sumOfSequence;
}

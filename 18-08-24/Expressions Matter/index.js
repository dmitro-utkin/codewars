...
// You cannot swap the operands. For example, with the given numbers, 
// you cannot get the expression (1 + 3) * 2 = 8.
// Input and Output Examples

console.log(expressionMatter(1, 2, 3)) //==> 9, because (1 + 2) * 3 = 9.
console.log(expressionMatter(1, 1, 1)) //==> 3, because 1 + 1 + 1 = 3.
console.log(expressionMatter(9, 1, 1)) //==> 18, because 9 * (1 + 1) = 18.
// ------------------------------------

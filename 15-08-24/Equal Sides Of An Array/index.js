...
const arr1 = [1, 100, 50, -51, 1, 1];
// You are given the array {1,100,50,-51,1,1}:
// Your function will return the index 1, because
// at the 1st position of the array, the sum of left side
//  of the index ({1}) and the sum of the
...
// 2. if the sum of the left side is equal to the sum of the right side return the index
// 3. if the sum of the left side is not equal to the sum of the right side return -1
...
function findEvenIndex(arr) {
  ...
  for (let i = 0; i < arr.length; i += 1) {
    ...
    console.log(`Поточний елемент: ${arr[i]}, підрахунок правої суми: ${totalSum - leftSum - arr[i]}`);
    leftSum += arr[i];
  }

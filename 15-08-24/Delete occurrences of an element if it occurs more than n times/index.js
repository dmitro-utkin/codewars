...
// Both of them took many pictures of the places 
...
// He tells them that he will only sit for the session 
// if they show the same motif at most N times. Luckily, 
...
// is [1,2,3,1,2,1,2,3], you take [1,2,3,1,2], 
...
// 3. if the element <= N, push it to the array
// 4. if the element > N, return the array
...
//       res.push(arr[i]);
//     } else if (res.filter((el) => el === arr[i]).length < n) {
//       res.push(arr[i]);
//     }
//   }
//   return res;
